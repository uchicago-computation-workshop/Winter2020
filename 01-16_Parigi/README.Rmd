...
department <- "Lead Trust Scientist - Airbnb"
university <- "PhD Candidate - University of Illinois at Urbana-Champaign, School of Information Sciences"
...
week_paper_ref0 <- "Nata Barbosa, Emily Sun, Judd Antin, and Paolo Parigi 2018. 'Designing for Trust: A Behavioral Framework for Sharing Economy Platforms'"
week_paper_file0 <- ""
...
<h1 class=pfblock-header3> `r speaker` and Natã Barbosa</h1>
